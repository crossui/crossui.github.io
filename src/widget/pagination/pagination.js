...
(function (factory) {
    ...
    var Page = function (element, options) {
        ...
        this.$page = $('<ul class="c-pagination-page"></ul>').hide();
        this.$size = $('<div class="c-pagination-size"></div>').hide();
        this.$jump = $('<div class="c-pagination-jump"></div>').hide();
        this.$info = $('<div class="c-pagination-info"></div>').hide();
    ...
    Page.prototype = {
        ...
        initHtml: function () {
            ...
            //init jump module
            var jumpHtml = '<div class="c-pagination-group"><input data-page-btn="jump" type="text"><button data-page-btn="jump" type="button">' + this.options.jumpBtnText + '</button></div>';
